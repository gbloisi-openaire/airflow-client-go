...
type DAGDetailsResponse struct {
	...
	Deadline []DeadlineAlertResponse `json:"deadline"`
...
// If the value is explicit nil, the zero value for []DeadlineAlertResponse will be returned
func (o *DAGDetailsResponse) GetDeadline() []DeadlineAlertResponse {
	if o == nil {
		var ret []DeadlineAlertResponse
		return ret
	}
