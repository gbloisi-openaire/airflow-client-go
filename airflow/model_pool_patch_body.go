...
type _PoolPatchBody PoolPatchBody
...
func (o *PoolPatchBody) UnmarshalJSON(data []byte) (err error) {
	varPoolPatchBody := _PoolPatchBody{}

	err = json.Unmarshal(data, &varPoolPatchBody)

	if err != nil {
		return err
	}

	*o = PoolPatchBody(varPoolPatchBody)
