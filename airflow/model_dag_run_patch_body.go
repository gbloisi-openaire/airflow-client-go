...
type _DAGRunPatchBody DAGRunPatchBody
...
func (o *DAGRunPatchBody) UnmarshalJSON(data []byte) (err error) {
	varDAGRunPatchBody := _DAGRunPatchBody{}

	err = json.Unmarshal(data, &varDAGRunPatchBody)

	if err != nil {
		return err
	}

	*o = DAGRunPatchBody(varDAGRunPatchBody)
