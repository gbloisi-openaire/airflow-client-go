...
type _ClearTaskInstancesBody ClearTaskInstancesBody
...
func (o *ClearTaskInstancesBody) UnmarshalJSON(data []byte) (err error) {
	varClearTaskInstancesBody := _ClearTaskInstancesBody{}

	err = json.Unmarshal(data, &varClearTaskInstancesBody)

	if err != nil {
		return err
	}

	*o = ClearTaskInstancesBody(varClearTaskInstancesBody)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "only_running")
		delete(additionalProperties, "reset_dag_runs")
		delete(additionalProperties, "task_ids")
		delete(additionalProperties, "dag_run_id")
		delete(additionalProperties, "include_upstream")
		delete(additionalProperties, "include_downstream")
		delete(additionalProperties, "include_future")
		delete(additionalProperties, "include_past")
