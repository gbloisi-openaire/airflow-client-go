...
type _TaskInstancesBatchBody TaskInstancesBatchBody
...
func (o *TaskInstancesBatchBody) UnmarshalJSON(data []byte) (err error) {
	varTaskInstancesBatchBody := _TaskInstancesBatchBody{}

	err = json.Unmarshal(data, &varTaskInstancesBatchBody)

	if err != nil {
		return err
	}

	*o = TaskInstancesBatchBody(varTaskInstancesBatchBody)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "dag_ids")
		delete(additionalProperties, "dag_run_ids")
		...
		delete(additionalProperties, "duration_gte")
		delete(additionalProperties, "duration_lte")
