...
func (a *DagReportAPIService) GetDagReportsExecute(r ApiGetDagReportsRequest) (interface{}, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DagReportAPIService.GetDagReports")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/dagReports"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.subdir == nil {
		return localVarReturnValue, nil, reportError("subdir is required and must be specified")
	}

	parameterAddToHeaderOrQuery(localVarQueryParams, "subdir", r.subdir, "form", "")
