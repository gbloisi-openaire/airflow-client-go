...
type _PatchTaskInstanceBody PatchTaskInstanceBody
...
func (o *PatchTaskInstanceBody) UnmarshalJSON(data []byte) (err error) {
	varPatchTaskInstanceBody := _PatchTaskInstanceBody{}

	err = json.Unmarshal(data, &varPatchTaskInstanceBody)

	if err != nil {
		return err
	}

	*o = PatchTaskInstanceBody(varPatchTaskInstanceBody)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "new_state")
